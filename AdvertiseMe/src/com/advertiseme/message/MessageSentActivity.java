...
public class MessageSentActivity extends StartPanelActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_messagesent);
	...
	void setupStart() {
		...
		txtSentCount=(TextView)findViewById(R.id.txtSentCount);
		
		itemMessage = getMessageList();
		lvMessage = (ListView) findViewById(R.id.lvMessageSent);
...
String mailID=obj_itemDetails.getItemId();
				...
				Intent intent=new Intent(MessageSentActivity.this,
				...
				intent.putExtra("MESSAGE_TYPE", 2); // Sent message
	...
	private ArrayList<ListItemDetails> getMessageList() {
		...
		resultList = webServiceCall.getMessageSentList(userID);
		...
		if (resultList != null) {
			...
			txtSentCount.setText("Messages ("+resultsList.size() +")");
		}
		...
		item_details
				.setTextFooter("Hi prageeth, I have the iMac you requested");
