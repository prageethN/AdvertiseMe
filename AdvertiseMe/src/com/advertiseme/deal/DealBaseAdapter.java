...
public class DealBaseAdapter extends BaseAdapter {
	...
	public DealBaseAdapter(Context context, ArrayList<ListItemDetails> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = l_Inflater.inflate(R.layout.row_format_deal, null);
		...
		holder.txt_Extras.setText(itemDetailsrrayList.get(position)
				.getTextExtra());
		holder.txt_Extras.setPaintFlags(holder.txt_Normal.getPaintFlags()
