...
public class ExpiredListBaseAdapter extends BaseAdapter {
	...
	public ExpiredListBaseAdapter(Context context, ArrayList<ListItemDetails> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = l_Inflater.inflate(R.layout.row_format_expired, null);
			...
			holder.txt_Status=(TextView) convertView.findViewById(R.id.text5);
		...
		holder.txt_Extras.setText(itemDetailsrrayList.get(position)
				.getTextExtra());
		holder.txt_Status.setText("Expired on "+itemDetailsrrayList.get(position)
				.getTextStatus());	
