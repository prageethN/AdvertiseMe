...
public class BestofferBaseAdapter extends BaseAdapter {
	...
	public BestofferBaseAdapter(Context context, ArrayList<ListItemDetails> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = l_Inflater.inflate(R.layout.row_format_bestoffer, null);
			...
			holder.txt_BuyerOffer=(TextView) convertView.findViewById(R.id.text5);
			holder.txt_MyOffer=(TextView) convertView.findViewById(R.id.text6);
		...
		holder.txt_Footer.setText(itemDetailsrrayList.get(position)
				.getTextFooter());
		holder.txt_BuyerOffer.setText("Buyer Offer: "+itemDetailsrrayList.get(position)
				.getTextExtra());
