...
public class ScheduleBaseAdapter extends BaseAdapter {
	...
	public ScheduleBaseAdapter(Context context, ArrayList<ListItemDetails> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = l_Inflater.inflate(R.layout.row_format_schedule, null);
		...
		holder.txt_Normal.setText(itemDetailsrrayList.get(position)
				.getTextNormal());
		holder.txt_Footer.setText("From "+itemDetailsrrayList.get(position)
				.getTextFooter());
		holder.txt_Status.setText(itemDetailsrrayList.get(position)
				.getTextExtra());
