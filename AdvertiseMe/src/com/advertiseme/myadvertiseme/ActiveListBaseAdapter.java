...
public class ActiveListBaseAdapter extends BaseAdapter {
	...
	public ActiveListBaseAdapter(Context context, ArrayList<ListItemDetails> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = l_Inflater.inflate(R.layout.row_format_activelist, null);
		...
		Boolean isStatusTrue= itemDetailsrrayList.get(position).getConditionStatus();
		if(isStatusTrue){
